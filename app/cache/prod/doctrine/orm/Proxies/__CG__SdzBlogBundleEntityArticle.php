...
class Article extends \Sdz\BlogBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'date', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'titre', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'auteur', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'contenu', '' . "\0" . 'Sdz\\BlogBundle\\Entity\\Article' . "\0" . 'publication');
        }
