...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sdz_blog.crawler' => 'getSdzBlog_CrawlerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Sdz/BlogBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Symfony\\Bundle\\SecurityBundle\\Entity');
        $c->addDriver($b, 'Sdz\\BlogBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\Entity', 'SdzBlogBundle' => 'Sdz\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c0ac198be9e20d4e7f6cb2c1033ce00f3520ae4b280595301390a1689b893f91');
    ...
    /**
     * Gets the 'sdz_blog.crawler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sdz\BlogBundle\Crawler\Crawler A Sdz\BlogBundle\Crawler\Crawler instance.
     */
    protected function getSdzBlog_CrawlerService()
    {
        return $this->services['sdz_blog.crawler'] = new \Sdz\BlogBundle\Crawler\Crawler('fr', 500000);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('guestmailuser@gmail.com');
        $a->setPassword('Azerty5+');
        $a->setAuthMode(NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Sdz/BlogBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Sdz/BlogBundle/Resources/translations/messages.en.xlf'), 'en', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Orga/TimeBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.de.yml'), 'de', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.ru.yml'), 'ru', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Orga/TimeBundle/Resources/views'), 'OrgaTime');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dzhfjiozkdk54!');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5511743cbfb8a')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OrgaTimeBundle' => 'Orga\\TimeBundle\\OrgaTimeBundle',
            ...
            'mailer_user' => 'guestmailuser@gmail.com',
            'mailer_password' => 'Azerty5+',
            'locale' => 'fr',
            'secret' => 'dzhfjiozkdk54!',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'guestmailuser@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Azerty5+',
